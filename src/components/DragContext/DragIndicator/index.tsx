/**
 * Adapted from pdnd-solid-tailwind
 *
 * @author dotnize
 * @link https://github.com/dotnize/pdnd-solid-tailwind
 * @license MIT
 */
...
import { listItemGap } from "../../../utils/constants";
 ...
 */
export function DropIndicator(props: { edge: Edge; class?: string }) {
	return (
		<div
			style={
				{
					"--line-thickness": `${strokeSize}px`,
					// "--line-offset": `calc(0.5 * (${listItemGap} + ${strokeSize}px))`,
					"--line-offset": `calc(-0.5 * ${strokeSize}px)`,
